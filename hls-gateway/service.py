...
def recordings_page():
    ...
    body = (f"<html><head><meta name='viewport' "
            ...
            f"flex-shrink:0}}"
            f".ch-logo{{width:32px;height:32px;object-fit:contain;border-radius:4px;"
            f"vertical-align:middle;margin-right:8px;background:#fff;"
            f"padding:2px;flex-shrink:0;box-sizing:border-box}}"
